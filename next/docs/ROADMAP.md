# Cohorte Next — périmètre et suite

Cohorte Next est un prototype indépendant destiné à reprendre les étapes de Cohorte V2 avec des transitions contrôlées par le moteur. Ce draft permet de relire le noyau, ses frontières d'exécution et ses premiers essais avant de développer le parcours complet.
...
Le support de Claude via abonnement, les autres gestionnaires de paquets (dont les monorepos pnpm), audit/refactor/retro, le travail parallèle et l'interface de suivi restent des extensions ultérieures. Ce draft ne prétend pas être à parité avec V2 ou V3.
