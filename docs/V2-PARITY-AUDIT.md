...
| Spec | Existing agent draft plus per-question acceptance of proposed answers and project overview | A live Codex read-only proposal on a synthetic repository produced cited scenarios and valid surface/check IDs; terminal interview, structured proposal path, guided editing of existing scenarios/criteria and Claude remain unqualified |
