...
| --- | --- | --- |
| G0 | Real provider auth, subscription route, capabilities, stop/resume | Codex 0.155.1 passed smoke/read-only/interrupt/resume on Darwin arm64; remaining cases open; Claude unavailable |
...
| G5 | AC01–AC30 and model qualification corpus | Started: 14 passed, 12 partial, 1 blocked, 1 deferred and 2 not started; the model corpus remains open |
