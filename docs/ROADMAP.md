...
| G5 | AC01–AC30 and model qualification corpus | In progress: 27 passed, 3 partial, 0 blocked and 0 deferred; AC02 and AC30 pass on their qualified boundaries, while François and the model corpus remain open |
