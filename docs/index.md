...
Le moteur Python s’installe avec `uv tool install 'cohorte-engine==1.0.0a7'` et fournit `cohorte`. L’ancien paquet npm correspond à V2. Vérifiez toujours la version utilisée avec `cohorte --version`.
