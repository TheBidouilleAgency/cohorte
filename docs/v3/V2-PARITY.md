...
| Loop reducer | `commands/loop/reducer.ts` plus core `LoopController` | workflow and core loop tests | Implemented for durable start/resume, fresh-verdict checks and bounded phase rounds; full V2 surface-selective reviewer retry/history remains |
