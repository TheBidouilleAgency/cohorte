...
export const COMMAND_MODULES: Readonly<Record<string, () => Promise<unknown>>> = Object.freeze({
  ...
  intake: () => import('./commands/intake/index.ts'),
  audit: () => import('./commands/audit/index.ts'),
  refactor: () => import('./commands/refactor/index.ts'),
  fleet: () => import('./commands/fleet/index.ts'),
  retro: () => import('./commands/retro/index.ts'),
  'align-ds': () => import('./commands/align-ds/index.ts'),
  'update-pipeline': () => import('./commands/update-pipeline/index.ts'),
